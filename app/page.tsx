...
export const metadata: Metadata = {
  title: 'NoteFlow API',
  description: 'API REST para la gestión de notas, listas e ideas con autenticación JWT.',
};
...
export default function Home() {
  ...
  const js = `
    ...
    function render() {
      ...
      EPS.forEach((ep, i) => {
        if (ep.auth && !shown) { html += '<div class="section-title" style="margin:28px 0 12px">Notas & Items — requieren JWT</div>'; shown = true; }
